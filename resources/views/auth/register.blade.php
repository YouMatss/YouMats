                    ...
                    <div class="borders-radius-17 border p-4 mt-4 mt-md-0 px-lg-10 py-lg-9">
                        <div class="tab-content" id="Jpills-tabContent">
                            <div class="tab-pane fade active show" id="Jpills-one-example1" role="tabpanel" aria-labelledby="Jpills-one-example1-tab">
                                <div class="row">
                                    <div class="col-md-12">
                                        <p class="text-gray-90 mb-4">{{ $authType == 'vendor' ? 'Register as a vendor' : 'Create new account today to reap the benefits of a personalized shopping experience.' }}</p>
                                    </div>
                                </div>
                                <form method="POST" action="{{ $authType == 'user' ? route('register') : route('vendor.registerForm') }}">
                                    @csrf
                                    <div class="row">
                                        @if($authType != 'vendor')
                                            <div class="col-md-12">
