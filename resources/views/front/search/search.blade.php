...
@section('metaTags')
    <title>{{ $q . ' | ' . nova_get_setting_translate('site_name') }}</title>
    <meta name="description" content="{{ $q . ' | ' . nova_get_setting_translate('site_name') }}">
    <meta name="keywords" content="{{ $q . ' | ' . nova_get_setting_translate('site_name') }}">

    <meta property="og:url" content="{{url()->current()}}" />
    <meta property="og:title" content="{{ $q . ' | ' . nova_get_setting_translate('site_name') }}" />
    <meta property="og:description" content="{{ $q . ' | ' . nova_get_setting_translate('site_name') }}" />
    <meta property="og:image" content="{{ $staticImages->getFirstMediaUrlOrDefault(LOGO_PATH, 'size_height_45')['url'] }}" />

    <meta name="twitter:card" content="summary">
    <meta name="twitter:site" content="@YouMats">
    <meta name="twitter:title" content="{{ $q . ' | ' . nova_get_setting_translate('site_name') }}">
    <meta name="twitter:description" content="{{ $q . ' | ' . nova_get_setting_translate('site_name') }}">
