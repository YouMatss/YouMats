                            ...
                            <div style="display: contents;" id="productRegion">
                                ...
                                <div class="col-md-4">
                                    <div class="js-form-message mb-6">
                                        ...
                                        <input type="number" class="form-control st_input @error('price') is-invalid @enderror" value="{{ $product->price }}" name="price" placeholder="">
                                        @error('price')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-md-4">
                                    <div class="js-form-message mb-6">
                                        ...
                                        <input type="number" class="form-control st_input @error('stoke') is-invalid @enderror" value="{{ $product->stoke }}" name="stoke" placeholder="">
                                        @error('stoke')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-md-4">
                                    <div class="js-form-message mb-6">
                                        ...
                                        <input type="text" class="form-control st_input @error('unit') is-invalid @enderror" value="{{ $product->unit }}" name="unit" placeholder="">
                                        @error('unit')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
