                            ...
                            <div class="product-item__outer h-100 w-100">
                                <div class="product-item__inner px-xl-4 p-3">
                                    <div class="product-item__body pb-xl-2">
                                        <div class="mb-2">
                                                <a href="{{ route('vendor.show', ['vendor' => $vendor->id, 'name' => $vendor->name]) }}" class="d-block text-center"><img class="img-fluid" src="{{ $vendor->getFirstMediaUrlOrDefault(VENDOR_LOGO)['url'] }}" alt="{{ $vendor->getFirstMediaUrlOrDefault(VENDOR_LOGO)['alt'] }}"></a>
                                        </div>
