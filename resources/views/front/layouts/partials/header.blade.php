...
<header id="header" class="u-header u-header-left-aligned-nav">
    <div class="u-header__section shadow-none" id="u-header__section">
        ...
        <!-------- logo & menu -------->
        <div class="py-2 bg-primary-down-lg nav_fixed" style="background-color: #131921 !important;">
            <div class="container my-0dot5 my-xl-0">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <nav class="navbar navbar-expand u-header__navbar py-0 justify-content-xl-between">
                            <a class="order-1 order-xl-0 navbar-brand u-header__navbar-brand u-header__navbar-brand-center" href="{{route('home')}}" aria-label="">
                                <img loading="lazy" alt="{{env('APP_NAME')}}" src="{{asset('assets/img')}}/logo.png{{-- $staticImages->getFirstMediaUrlOrDefault(LOGO_PATH,'size_height_45')['url'] --}}">
                            </a>
                                                    ...
                                                    <li class="u-has-submenu u-header-collapse__submenu">
                                                        ...
                                                        <div id="{{$category->slug}}" class="collapse" data-parent="#headerSidebarContent">
                                                            <ul id="headerSidebarHomeMenu" class="u-header-collapse__nav-list">
                                                                ...
                                                                <li><a class="u-header-collapse__submenu-nav-link" href="{{route('front.category', [$category->slug.'/'.$child->slug])}}">{{$child->name}}</a></li>
                                                                @endforeach
                                                            </ul>
                                                        </div>
                                                    </li>
                    ...
                    <!-- My Account div [START] -->
                    <div class="d-none d-xl-block col-md-auto" style="border: 2px solid #232f3e;border-radius: 5px;">
                            <div class="d-flex align-items-center">
                                <div class="position-relative">
                                    ...
                                    <span class="d-sm-inline-flex align-items-center">
                                        <i class="ec ec-user mr-1"></i>
                                        {{__('general.myaccount')}}
                                    </span>
                                    </a>
                                    <div id="userTypeDropdown1" class="dropdown-menu dropdown-unfold" style="min-width: 450px;" aria-labelledby="userTypeDropdownInvoker2">
                                        <div class="container">
                                            <div class="row">

                                                <div class="col-6" style="border-left: 1px solid #9d9d9d7a;">
                                                    <!-- Visitor type  [Start]-->
                                                    @if (is_company())
                                                        <a class="dropdown-item typeIntroduceButton" data-url="{{route('front.introduce', ['individual'])}}">{{__('general.continue_as_individual')}}</a>
                                                    @else
                                                    ...
                                                    @if(\Config::get('currencies'))
                                                        ...
                                                        <div id="languageDropdown" class="dropdown-item" aria-labelledby="languageDropdownInvoker">
                                                            @foreach(\Config::get('currencies') as $currency)
                                                            <a class="dropdown-item active currency_button" data-code="{{$currency->code}}" href="#">
                                                                <img loading="lazy" width="20px" alt="{{$currency->getFirstMediaUrlOrDefault(CURRENCY_PATH)['alt']}}" src="{{$currency->getFirstMediaUrlOrDefault(CURRENCY_PATH, 'size_20_20')['url']}}" />&nbsp;
                                                                {{$currency->code}} @if($currency->symbol) ({{$currency->symbol}}) @endif
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    @elseif(Auth::guard('web')->check() && !Auth::guard('vendor')->check())
                                                            <a class="dropdown-item" style="text-align: center;"> {{auth('web')->user()->name}} </a>
                                                            <hr style="margin: 5px;">
                                                    ...
                                                    @elseif(auth()->guard('vendor')->check())
                                                           <a class="dropdown-item" style="text-align: center;"> {{auth('vendor')->user()->name}} </a>
                                                           <hr style="margin: 5px;">
                                ...
                                <ul class="d-flex list-unstyled mb-0">
                                    <li class="col pr-0">
                                        <a href="{{ route('cart.show') }}" class="text-gray-110 position-relative d-flex " data-toggle="tooltip" data-placement="top" title="Cart">
                                            <i class="font-size-28 ec ec-shopping-bag"></i>
                        ...
                        <div class="d-inline-flex">
                            <ul class="d-flex list-unstyled mb-0 align-items-center">
                                ...
                                <li class="col d-xl-none px-2 px-sm-3">
                                    @if(Auth::guard('web')->check() && !Auth::guard('vendor')->check())
                                        <a href="{{route('front.user.profile')}}" class="text-white" data-toggle="tooltip" data-placement="top" title="My Account">
                                            <i class="font-size-22 ec ec-user"></i>
                                        </a>
                                    @elseif(!Auth::guard('vendor')->check())
                                        <a href="{{route('login')}}" class="text-white" data-toggle="tooltip" data-placement="top" title="Login">
                                            <i class="font-size-22 ec ec-user"></i>
                                        </a>
                                    @endif
                                </li>
                                <li class="col pr-xl-0 px-2 px-sm-3">
                                    <a href="{{ route('cart.show') }}" class="text-white position-relative d-flex" data-toggle="tooltip" data-placement="top">
        ...
        <div class="box_search_nav d-block d-lg-none">
            <div id="SearchBarMobile" class="input-group">
                ...
                <div class="input-group-append">
                    <!-- End Select -->
                    <button class="btn btn-dark height-40 py-2 px-2 rounded-right-pill" style="background-color: #febd69;border-color: #febd69;" type="button" id="searchProductBtnMobile">
        ...
        <!-------- search & cart -------->
        <div class="d-none d-xl-block bg-primary" id="searchAndCartDiv" style="background: #232f3e !important;">
            <div class="container">
                <div class="row align-items-stretch min-height-40 rtl">
                    <div class="col-md-auto d-none d-xl-flex align-items-end">
                        <div class="max-width-270 min-width-270">
                            <div id="basicsAccordion">
                                <div class="card border-0 rounded-0">
                                    <div class="card-header bg-primary rounded-0 card-collapse border-0 " id="basicsHeadingOne">
                                        <button type="button" class="btn-link btn-remove-focus btn-block d-flex card-btn mt-0 text-lh-1 shadow-none btn-primary rounded-top-lg border-0 font-weight-bold text-gray-90 collapsed" style="background-color: #232f3e;padding: 0.75rem;" data-toggle="collapse" data-target="#basicsCollapseOne" aria-expanded="false" aria-controls="basicsCollapseOne">
                                                    ...
                                                    <ul class="navbar-nav u-header__navbar-nav border-primary border-top-0">
                                                        ...
                                                        <li class="nav-item hs-has-mega-menu u-header__nav-item" data-event="hover" data-position="left">
                                                            <a id="{{$category->slug}}" class="nav-link u-header__nav-link u-header__nav-link-toggle"
                                                               href="{{route('front.category', $category->slug)}}" aria-haspopup="true" aria-expanded="false">{{$category->name}}</a>
                                                                ...
                                                                <div class="row u-header__mega-menu-wrapper">
                                                                    <div class="col mb-3 mb-sm-0">
                                                                        ...
                                                                        <ul class="u-header__sub-menu-nav-group mb-3">
                                                                            ...
                                                                            <li><a class="nav-link u-header__sub-menu-nav-link" href="{{route('front.category', [$category->slug.'/'.$child->slug])}}">{{$child->name}}</a></li>
                                                                            @endforeach
                                                                            <li>
                                                                        ...
                                                                        <div class="col mb-3 mb-sm-0">
                                                                            ...
                                                                            <ul class="u-header__sub-menu-nav-group mb-3">
                                                                                @foreach($categories->skip(17)->take(10) as $category)
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="{{route('front.category', [$category->slug.'/'.$child->slug])}}">{{$category->name}}</a></li>
                                                                                @endforeach
                                                                            </ul>
                                                                        </div>
                    ...
                    <div class="col align-self-center">
                        ...
                        <ul class="list-inline mb-0">
                            ...
                            <li class="list-inline-item mr-0 u-header-topbar__nav-item u-header-topbar__nav-item-border">
                                <a class="u-header-topbar__nav-link" href="{{route('front.product.all')}}">{{__('general.all_products')}}</a>
                            </li>
                            <li class="list-inline-item mr-0 u-header-topbar__nav-item u-header-topbar__nav-item-border">
                                <a class="u-header-topbar__nav-link" href="{{route('vendor.index')}}">{{__('general.our_partners')}}</a>
                            </li>
                            <li class="list-inline-item mr-0 u-header-topbar__nav-item u-header-topbar__nav-item-border">
                                <a class="u-header-topbar__nav-link" href="{{route('front.faqs.page')}}">{{__('general.faq')}}</a>
                            </li>
