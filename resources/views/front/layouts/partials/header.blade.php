                            ...
                            <ul class="d-flex list-unstyled mb-0">
                                <li class="col pr-0">
                                    <a href="{{ route('cart.show') }}" class="text-gray-110 position-relative d-flex " data-toggle="tooltip" data-placement="top" title="Cart">
                                        <i class="font-size-22 ec ec-shopping-bag"></i>
                                        <span class="width-22 height-22 bg-dark position-absolute flex-content-center text-white rounded-circle left-12 top-8 font-weight-bold font-size-12" id="cartCount">{{ Cart::count() }}</span>
                                        <span class="font-weight-bold font-size-16 text-gray-110 ml-3" id="cartTotal">{{ getCurrency('code'). ' ' . Cart::total() }}</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
