...
class ThirdCategory extends Model implements Sortable, HasMedia
{
    use SoftDeletes, HasFactory, SortableTrait, HasTranslations, InteractsWithMedia, DefaultImage, CascadeSoftDeletes, BelongsToThrough;
    ...
    public function registerAllMediaConversions(): void {
        ...
        $this->addMediaConversion('cropper')->performOnCollections(THIRD_CATEGORY_PATH);
    }
