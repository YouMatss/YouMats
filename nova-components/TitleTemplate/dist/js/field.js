...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-title-template', __webpack_require__(3));
  Vue.component('detail-title-template', __webpack_require__(6));
  Vue.component('form-title-template', __webpack_require__(9));
});
