...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-generate-products', __webpack_require__(3));
  Vue.component('detail-generate-products', __webpack_require__(6));
  Vue.component('form-generate-products', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        ...
        endpoint: function endpoint() {
            return this.field.endpoint.replace('{' + this.field.category + '}', this.category ? this.category : '').replace('{model}', this.resourceId ? this.resourceId : null);
        }
    },
    methods: {
  ...
  return _c(
    ...
    [
      _c("template", { slot: "field" }, [
        _vm.template == null
          ? _c("div", [_vm._v("The selected category doesn't have a template")])
          : _c(
              "div",
                      ...
                      item.word[locale].split("")[0] == "+"
                        ? _c("div", [
                            _c("input", {
                              ...
                              staticClass:
                                "form-control form-input form-input-bordered inline-block w-auto mb-1",
